...
command!          IcedTestBufferOpen        call iced#state#get('error_buffer').open()

command!          IcedStdoutBufferOpen      call iced#state#get('stdout_buffer').open()
command!          IcedStdoutBufferClear     call iced#state#get('stdout_buffer').clear()
command!          IcedStdoutBufferClose     call iced#state#get('stdout_buffer').close()
...
command!          IcedDocumentClose         call iced#state#get('document_buffer').close()
