...
execute join(['function! vital#_iced#Data#String#Interpolation#import() abort', printf("return map({'interpolate': ''}, \"vital#_iced#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
