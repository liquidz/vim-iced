...
*** https://github.com/nrepl/nrepl/pull/335
// }}}

== 3.15.3283 (2024-02-29)
// {{{
=== Changed
...
// {{{
=== Added
* https://github.com/liquidz/vim-iced/issues/448[#448]: Added `IcedTestBufferClose` command.
...
// {{{
=== Fixed
* https://github.com/liquidz/vim-iced/issues/447[#447]: Fixed popup window to work with neovim 0.8.0.
// }}}
...
// {{{
=== Changed
* Updated to use https://github.com/liquidz/build.edn[build.edn] for releasing workflow.
// }}}
...
=== Fixed
* https://github.com/liquidz/vim-iced/issues/423[#423]: Fixed again a bug about evaluating reader conditionals.
// }}}
